...
async function approve(parameter){
  let sessionResponse = await fetch("http://localhost:9001/session");
  ...
  console.log(reimbId)
  let response = await fetch("http://localhost:9001/reimbursement/"+parameter.reimbId, {
      method: "PATCH",
...
async function deny(parameter){
  ...
  let reimbIdElem = parameter.reimbId;
