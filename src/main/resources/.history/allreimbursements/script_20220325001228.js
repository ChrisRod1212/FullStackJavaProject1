...
async function approve(){
    ...
    console.log(reimbursement);
    let response = await fetch("http://localhost:9001/reimbursement/"+argureimbIdElemments, {
        method: "PATCH",
...
async function deny(){
    ...
    console.log(reimbursement);
    let response = await fetch("http://localhost:9001/reimbursement/"+arguments, {
        method: "PATCH",
        body: JSON.stringify(reimbursement)  
    });
